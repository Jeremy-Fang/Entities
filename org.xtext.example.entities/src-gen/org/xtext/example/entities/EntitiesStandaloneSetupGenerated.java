...
public class EntitiesStandaloneSetupGenerated implements ISetup {
	...
	public void register(Injector injector) {
		if (!EPackage.Registry.INSTANCE.containsKey("http://www.xtext.org/example/entities/Entities")) {
			EPackage.Registry.INSTANCE.put("http://www.xtext.org/example/entities/Entities", EntitiesPackage.eINSTANCE);
		}
